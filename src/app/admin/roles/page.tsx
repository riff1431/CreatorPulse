    ...
    >
      <div className="max-w-7xl mx-auto space-y-6 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-5 flex items-center gap-4 bg-slate-50 border-slate-200/80 col-span-1 md:col-span-2">
            <div className="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 shrink-0 shadow-sm border border-indigo-100">
              <Sparkles size={20} />
            </div>
            <div className="space-y-1">
              <h3 className="font-extrabold text-sm text-slate-800">Granular Authorization Engine</h3>
          ...
          <Card className="p-5 space-y-3 bg-white border-slate-200/80">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-bold shadow-xs cursor-pointer"
              >
                {roles
                  ...
                  return (
                    <tr key={r.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="py-4 px-5">
                        <code className="bg-slate-100 text-indigo-700 px-2 py-0.5 rounded-lg border border-slate-300 font-mono text-[10px] font-bold">
                          {r.id}
                        </code>
                      </td>
          ...
          <form onSubmit={handleCreateRole} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-medium"
                  required
                />
              </div>
              <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-white border border-slate-200 rounded-xl p-3 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-medium"
              />
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] font-black uppercase text-[#71717A]">Granular Permissions Checklist</label>
              <div className="max-h-48 overflow-y-auto border border-slate-200 rounded-2xl divide-y divide-slate-200/60 p-2 bg-slate-50/50 space-y-1.5">
                  ...
                  return (
                    <label key={key} className="flex items-start gap-2.5 p-2 rounded-xl hover:bg-white transition-colors cursor-pointer">
                      <input
                        ...
                        className="mt-0.5 accent-[#4F46E5] h-3.5 w-3.5"
                      />
                      <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-slate-200 rounded-xl px-2 py-1 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-bold"
              >
          ...
          <form onSubmit={handleEditRole} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-white disabled:bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-medium"
                required
              />
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) => setRoleStatus(e.target.value as 'active' | 'inactive')}
                disabled={roles.find(r => r.id === roleId)?.is_builtin}
                className="bg-white disabled:bg-slate-50 border border-slate-200 rounded-xl px-2 py-1 text-xs text-[#18181B] focus:outline-none focus:border-indigo-500 font-bold"
              >
                <option value="active">Active</option>
                <option value="inactive">Inactive</option>
              </select>
