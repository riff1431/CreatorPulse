  ...
  return (
    ...
    >
      <button
        ...
        } ${checked ? 'bg-gradient-to-r from-[#EC4899] to-[#F43F5E]' : 'bg-[#E4E4E7] dark:bg-[#3A2A4C]'}`}
      >
        <span
          className={`block rounded-full bg-white shadow-md transform transition-transform duration-200 ${
            isSm
