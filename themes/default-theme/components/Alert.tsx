...
export const Alert: React.FC<AlertProps> = ({
  ...
  const defaultIcons = {
    ...
    gradient: <Sparkles size={16} className="text-[var(--color-primary)] " />,
  };

  const variantStyles = {
    info: 'bg-[var(--color-surface-secondary)] /70 border-[#FBCFE8] text-[var(--color-primary)] ',
    ...
    gradient: 'bg-gradient-to-r from-[#FFF1F7] to-[#FCE7F3] dark:from-[#241A30] dark:to-[#1A1222] border-[var(--color-border)] text-[var(--color-text-primary)] ',
  };
