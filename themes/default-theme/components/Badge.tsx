...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variantClasses = {
    pink: 'bg-[#FCE7F3] text-[#BE185D] border-[#FBCFE8] dark:bg-[#381A2B] dark:text-[#F472B6] dark:border-[#4C1D3B]',
    ...
    gradient: 'bg-gradient-to-r from-[#EC4899] to-[#F43F5E] text-white border-transparent shadow-xs',
  };
